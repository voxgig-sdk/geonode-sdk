...
// Geonode SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GeonodeMakeRequest
{
    public static function call(GeonodeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GeonodeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GeonodeResponse($fetched);
        } else {
