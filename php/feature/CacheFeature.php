...
class GeonodeCacheFeature extends GeonodeBaseFeature
{
    ...
    private function _through(GeonodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
