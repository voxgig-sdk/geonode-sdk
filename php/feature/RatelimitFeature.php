...
class GeonodeRatelimitFeature extends GeonodeBaseFeature
{
    ...
    private function _acquire(GeonodeContext $ctx): void
    {
    ...
    private function _track(GeonodeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
