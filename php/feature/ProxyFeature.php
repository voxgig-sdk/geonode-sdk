...
class GeonodeProxyFeature extends GeonodeBaseFeature
{
    ...
    public function init(GeonodeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GeonodeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
