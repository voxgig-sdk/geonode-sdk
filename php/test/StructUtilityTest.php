...
// Geonode SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GeonodeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GeonodeOmni::structfix($now, Struct::undef()))
                        !== json_encode(GeonodeOmni::structfix($val, Struct::undef()))) {
