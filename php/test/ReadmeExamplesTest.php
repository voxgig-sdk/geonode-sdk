...
// Geonode SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GeonodeSDK::test)
...
{
    private const SDK_CLASS = 'GeonodeSDK';
    ...
    private const SDK_BASE = 'geonode_sdk';
