...
class GeonodeTestRunner
{
    ...
    {
        $live = self::getenv('GEONODE_TEST_LIVE');
        $override = self::getenv('GEONODE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GEONODE_TEST_EXPLAIN');
...
class_alias('GeonodeTestRunner', 'Runner');
class_alias('GeonodeHelpers', 'Helpers');
