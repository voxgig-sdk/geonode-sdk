# Geonode SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GeonodeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GeonodeSDK(...) and GeonodeSDK.test(...) become
#      GeonodeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "geonode_sdk"
_SDK_CLASS = "GeonodeSDK"
