...
from geonode_sdk.utility import register

# Load features
from geonode_sdk.feature.base_feature import GeonodeBaseFeature
from geonode_sdk.features import _has_feature, _make_feature
...
class GeonodeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GeonodeUtility()
        self._utility = utility

        from geonode_sdk.config import shared_config
    ...
    def get_utility(self):
        return GeonodeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GeonodeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Proxy(self, data=None) -> "ProxyEntity":
        ...
        from geonode_sdk.entity.proxy_entity import ProxyEntity
        return ProxyEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "GeonodeSDK":
        if sdkopts is None:
            sdkopts = {}
