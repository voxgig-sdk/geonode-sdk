# Geonode TypeScript SDK Reference

Complete API reference for the Geonode TypeScript SDK.
...
#### `GeonodeSDK.test(testopts?, sdkopts?)`
...
**Returns:** `GeonodeSDK` instance in test mode.
...
| `responseTime` | `number` | No | Average response time in milliseconds |
...
Return the parent `GeonodeSDK` instance.
