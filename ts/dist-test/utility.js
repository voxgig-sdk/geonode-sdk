...
function envOverride(m) {
    if ('TRUE' === process.env.GEONODE_TEST_LIVE ||
        'TRUE' === process.env.GEONODE_TEST_OVERRIDE) {
    ...
    m.GEONODE_TEST_EXPLAIN = process.env.GEONODE_TEST_EXPLAIN || m.GEONODE_TEST_EXPLAIN;
    return m;
}
