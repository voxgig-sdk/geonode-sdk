...
function liveScenariosActive() { return false && process.env.GEONODE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GeonodeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GEONODE_TEST_PROXY_ENTID'];
    ...
    const client = new __1.GeonodeSDK({
        base: 'http://localhost:8080',
