...
class GeonodeGraphql
{
    ...
    // equivalent.
    public static function body(GeonodeContext $ctx): mixed
    {
    ...
    public static function errors(GeonodeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
