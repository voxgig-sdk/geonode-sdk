...
class GeonodeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GeonodeSDK/1.0)';
    ...
    public static function call(GeonodeContext $ctx, string $fullurl, array $fetchdef): array
    {
