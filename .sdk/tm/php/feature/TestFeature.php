...
// Geonode SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GeonodeTestFeature extends GeonodeBaseFeature
{
    ...
    public function init(GeonodeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GeonodeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GeonodeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GeonodeContext $ctx, $op, $args): array
    {
