...
class GeonodeTimeoutFeature extends GeonodeBaseFeature
{
    ...
    private function _with_timeout(GeonodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GeonodeContext $_ctx, float $ms): void
    {
        $client = $this->client;
