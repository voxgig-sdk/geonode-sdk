...
class GeonodeStreamingFeature extends GeonodeBaseFeature
{
    ...
    private function _iterate(GeonodeResult $result): \Generator
    {
    ...
    private function _streamable(GeonodeContext $ctx): bool
    {
