...
class GeonodeRbacFeature extends GeonodeBaseFeature
{
    ...
    private function _required(GeonodeContext $ctx): ?string
    {
    ...
    private function _reject(GeonodeContext $ctx, string $required): void
    {
    ...
    private function _track(GeonodeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
