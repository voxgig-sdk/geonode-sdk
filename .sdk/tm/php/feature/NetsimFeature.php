...
class GeonodeNetsimFeature extends GeonodeBaseFeature
{
    ...
    private function _simulate(GeonodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GeonodeContext $ctx, array $applied): void
    {
        $client = $this->client;
