...
// Geonode SDK clienttrack feature
...
class GeonodeClienttrackFeature extends GeonodeBaseFeature
{
    ...
    public function PostConstruct(GeonodeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Geonode-SDK';
