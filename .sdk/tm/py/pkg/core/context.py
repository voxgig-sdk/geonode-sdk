...
from projectname_sdk.core.control import GeonodeControl
...
class GeonodeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, GeonodeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GeonodeError(code, msg, self)
