...
from projectname_sdk import GeonodeSDK
from projectname_sdk.core.spec import GeonodeSpec
from projectname_sdk.core.result import GeonodeResult
from projectname_sdk.core.response import GeonodeResponse
from projectname_sdk.core.operation import GeonodeOperation
from projectname_sdk.core.error import GeonodeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GeonodeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GeonodeSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GeonodeSDK.test(None, None)
        ...
        class TestInitFeature(GeonodeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GeonodeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GeonodeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GeonodeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GeonodeSDK.test(None, setup_opts)
