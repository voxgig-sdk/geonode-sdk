...
class GeonodeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeonodeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GeonodeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GeonodeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
