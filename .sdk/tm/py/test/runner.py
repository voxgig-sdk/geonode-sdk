...
class GeonodeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeonodeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GeonodeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GeonodeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
