...
|---|---|---|
| `ts/` | @voxgig-sdk/geonode-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/geonode-sdk \
      --repository voxgig-sdk/geonode-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/geonode-sdk` shows it, and
`npm trust revoke @voxgig-sdk/geonode-sdk --id=<id>` removes it.
