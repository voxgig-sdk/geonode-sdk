...
module GeonodeTestRunner
  ...
  def self.env_override(m)
    live = getenv("GEONODE_TEST_LIVE")
    override = getenv("GEONODE_TEST_OVERRIDE")
    ...
    explain = getenv("GEONODE_TEST_EXPLAIN")
    m["GEONODE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GeonodeTestRunner
Helpers = GeonodeHelpers
Vs = VoxgigStruct
