...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = GeonodeOmni.make_runner(TEST_JSON_FILE, GeonodeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : GeonodeOmni.errify(err)
    end
