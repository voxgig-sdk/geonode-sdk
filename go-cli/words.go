...
func registerSDKWords(r *eng.Registry, client *sdk.GeonodeSDK) {
...
func runOp(client *sdk.GeonodeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
