...
type Args struct {
	Entity string         `json:"entity" jsonschema:"proxy"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GeonodeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "geonode_list",
		Description: "List records from Geonode. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "geonode_load",
		Description: "Load a single record from Geonode. " +
...
func runOp(client *sdk.GeonodeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GeonodeSDK, name string) (sdk.GeonodeEntity, error) {
